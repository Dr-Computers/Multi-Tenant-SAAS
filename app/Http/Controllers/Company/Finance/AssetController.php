...
class AssetController extends Controller
{
    public function index()
    {
        // if (\Auth::user()->can('manage asset')) {
            ...
            return view('company.finance.asset.index', compact('assets'));
        // } else {
    ...
    public function create()
    {
        // if (\Auth::user()->can('create asset')) {
            ...
            return view('company.finance.asset.create', compact('properties'));
        // } else {
        //     return redirect()->back()->with('error', __('Permission Denied!'));
        // }
    }
    ...
    public function store(Request $request)
    {
        // if (\Auth::user()->can('create invoice payment')) {
            ...
            return redirect()->route('assets.index')->with('success', __('Assets successfully created.'));
        // } else {
        //     return redirect()->back()->with('error', __('Permission Denied!'));
        // }
    }
    ...
    public function edit($id)
    {
        if (\Auth::user()->can('edit asset')) {
            ...
            $asset = Asset::find($id);
            return view('asset.edit', compact('property', 'asset'));
        } else {
            return redirect()->back()->with('error', __('Permission Denied!'));
        }
    }
    ...
    public function update(Request $request, $id)
    {
        if (\Auth::user()->can('edit asset')) {
            ...
            return redirect()->route('assets.index')->with('success', __('Assets successfully Updated.'));
        } else {
            return redirect()->back()->with('error', __('Permission Denied!'));
        }
    }
