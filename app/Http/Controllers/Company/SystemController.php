...
class SystemController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('company.settings.index', compact('settings', 'company_payment_setting', 'invoiceTemplates', 'InvoiceSettings', 'letterPadTemplates', 'letterPadSettings'));
        // } else {
    ...
    // {
    //     return view('admin.settings.test_mail');
    // }
