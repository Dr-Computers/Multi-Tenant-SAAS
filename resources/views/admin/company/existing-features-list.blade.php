        ...
        <div class="col-lg-4">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <h6 class="my-2 fw-bold d-flex justify-between">Sub Total: <span id="subtotal">{{ adminPrice() }}
                            0.00</span></h6>
                    ...
                    <h6 class="my-2 fw-bold d-flex justify-between">Discount: <span id="discount">{{ adminPrice() }}
                            0.00</span></h6>
                    <div class="my-2 ">
                        <h6 class="form-label  mb-1 fw-bold d-flex gap-3 justify-between">Tax (5%) : <span
                                id="tax">{{ adminPrice() }} 0.00</span></h6>
                    </div>
                    ...
                    <h6 class="my-2 fw-bold d-flex justify-between">Grand Total: <span id="grandtotal">
                            {{ adminPrice() }} 0.00</span></h6>
