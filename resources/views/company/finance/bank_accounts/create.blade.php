...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('company.finance.bank-accounts.index') }}">{{ __('Bank Accounts') }}</a></li>
    <li class="breadcrumb-item">{{ __('Create') }}</li>
@endsection

@section('action-btn')
    <div class="d-flex">
        <a href="{{ route('company.finance.bank-accounts.index') }}" class="btn btn-sm btn-primary me-2" data-bs-toggle="tooltip" title="{{ __('Back') }}">
...
@section('content')
    <div class="row">
        <form action="{{ route('company.finance.bank-accounts.store') }}" method="POST" class="needs-validation" novalidate>
            @csrf
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
