...
@section('action-btn')
    @can('create a maintenance invoice')
        <div class="d-flex">
            <button href="#" data-size="lg" data-url="{{ route('owner.realestate.maintenance-requests.create') }}"
                ...
                <div class="card-body">
                    @can('maintenance requests listing')
                        ...
                        <div class="tab-content p-4 border border-top-0 rounded-bottom">
                            @if ($tab == 'all-requests')
                                @include('owner.realestate.maintenance-requests.partials.all-requests', [
                                    'allRequests' => $allRequests,
                                ])
                            @elseif($tab == 'pending-requests')
                                @include(
                                    'owner.realestate.maintenance-requests.partials.pending-requests',
                                    [
                            ...
                            @elseif($tab == 'in-progress-requests')
                                @include(
                                    'owner.realestate.maintenance-requests.partials.in-progress-requests',
                                    [
                            ...
                            @elseif($tab == 'completed-requests')
                                @include(
                                    'owner.realestate.maintenance-requests.partials.completed-requests',
                                    [
                            ...
                            @elseif($tab == 'ungenerated-invoices')
                                @include(
                                    'owner.realestate.maintenance-requests.partials.ungenerated-invoices',
                                    ['ungeneratedInvoices' => $ungeneratedInvoices]
                                )
                            @elseif($tab == 'due-invoices')
                                @include('owner.realestate.maintenance-requests.partials.due-invoices', [
                                    'dueInvoices' => $dueInvoices,
                                ])
                            @elseif($tab == 'paid-invoices')
                                @include('owner.realestate.maintenance-requests.partials.paid-invoices', [
