                        ...
                        <div class="info-group">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 col-lg-4">
                                    ...
                                    <input type="hidden" id="edit_invoice" name="invoice_id" value="{{ $payment->invoice->id }}">
                                ...
                                <div class="form-group col-md-6 col-lg-4" id="cheque_selection" style="display: none;">
                                    ...
                                    <input type="hidden" id="check_id" name="check_id" value="{{ $payment->invoice->cheque_id }}">
                                ...
                                <div class="form-group col-md-6 col-lg-4" id="account_selection" >
                                    ...
                                    <input type="hidden" id="account_id" name="account_id" value="{{ $payment->account->id ?? '' }}">
