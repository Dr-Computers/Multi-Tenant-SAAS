    ...
    <div class="row">
        ...
        <div class="col-xl-9">
            <div id="personal_info" class="card">
                ...
                <div class="card-body">
                    {{ Form::model($userDetail, ['route' => ['owner.profile.update'], 'method' => 'post', 'enctype' => 'multipart/form-data', 'class' => 'needs-validation', 'novalidate']) }}
                    @csrf
                    <div class="row">
            ...
            <div id="change_password" class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('owner.profile.update.password') }}" class="needs-validation"
                        novalidate>
                        @csrf
                        <div class="row">
