...
@section('action-btn')
    <div class="d-flex">
        <a href="#" data-size="md" data-url="{{ route('company.finance.realestate.invoices.create') }}"
            data-ajax-popup="true" data-bs-toggle="tooltip" title="{{ __('Create New Other Invoice') }}"
...
@section('content')
    <div class="row">
        <form action="{{ route('company.finance.realestate.invoice-other.store') }}" method="post" class="needs-validation"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="invoice_id" id="invoice_id" class="form-control"
                                            placeholder="{{ __('Enter Invoice Number') }}" value={{ $invoiceNumber }}>
                                    </div>
                                </div>
                            </div>
