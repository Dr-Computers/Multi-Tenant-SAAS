                                        ...
                                        <tbody>
                                            @foreach($unit->lease->cheques ?? [] as $key => $cheque)
                                                <tr>
                                                    ...
                                                    <td class="text-center mx-auto"><a href="{{ asset('storage/'.$cheque->chequeImage->file_url) }}" target="_blank"><img class="w-10 h-10 mx-auto" src="{{ asset('storage/'.$cheque->chequeImage->file_url) }}"/></a></td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
