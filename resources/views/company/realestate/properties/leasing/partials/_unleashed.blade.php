                                    ...
                                    <td>
                                        <div class="btn-group card-option">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                ...
                                                @if ($unit->lease && $unit->lease->status == 'under review')
                                                    {!! Form::open([
                                                        'method' => 'DELETE',
                                                    ...
                                                    <a href="#" class="dropdown-item bs-pass-para "
                                                        ...
                                                        title="{{ __('Delete Review Request') }}">
                                                        <i class="ti ti-trash text-dark "></i>
                                                        {{ __('Delete Review Request') }}</a>
                                                    {!! Form::close() !!}
                                                @else
                                                    <a class="dropdown-item" data-bs-toggle="tooltip"
                                                        title="{{ __('Add Lease') }}"
                                                        data-url="{{ route('company.realestate.properties.lease.create', $unit->id) }}"
                                                        data-size="lg" data-ajax-popup2="true"
                                                        data-original-title="{{ __('Add Lease') }}" href="#">
