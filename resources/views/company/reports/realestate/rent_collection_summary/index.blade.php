...
@section('content')
    <div class="row">
        <div style="display: flex; gap: 20px; align-items: center; flex-wrap: wrap; margin-bottom: 20px;">
            ...
            <form method="GET" action="{{ route('report.rent_collection.index') }}">
            ...
            <a href="{{ route('report.rent_collection.index') }}" class="btn btn-secondary btn-sm">
                {{ __('Clear') }}
            </a>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <table class="display dataTable cell-border datatbl-advance" data-report-name="Rent Collection Summary Report">
                        <thead>
                        <tr>
                            <th>{{__('Tenant')}}</th>
                            <th>{{__('Invoice')}}</th>
