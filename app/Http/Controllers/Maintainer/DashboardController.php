...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        if (Auth::check()) {
            ...
            return view('maintainer.dashboard.index', $data, compact('users', 'plan', 'storage_limit'));
        }
    }
    ...
    public function profile()
    {
        ...
        return view('maintainer.profile.index', compact('userDetail'));
    }
    ...
    public function updatePassword(Request $request)
    {
        if (Auth::Check()) {
            ...
            if (Hash::check($request_data['current_password'], $current_password)) {
                ...
                return redirect()->route('maintainer.profile', $objUser->id)->with('success', __('Password successfully updated.'));
            } else {
                return redirect()->route('maintainer.profile', $objUser->id)->with('error', __('Please enter correct current password.'));
            }
        } else {
            return redirect()->route('maintainer.profile', \Auth::user()->id)->with('error', __('Something is wrong.'));
        }
    }
}
