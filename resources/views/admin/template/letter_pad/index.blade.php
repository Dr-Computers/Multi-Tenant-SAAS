...
@section('page-title')
    {{ __('Manage Letter Pad Templates') }}
@endsection
@section('title')
    <div class="d-inline-block">
        <h5 class="h4 d-inline-block font-weight-400 mb-0">{{ __('Letter Pad Templates') }}</h5>
    </div>
@endsection
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Dashboard') }}</a></li>
    <li class="breadcrumb-item active" aria-current="page">{{ __('Letter Pad Template') }}</li>
@endsection
@section('action-btn')
    <div class="float-end">
        @can('create letter pad template')
            <a href="#" data-size="lg" data-url="{{ route('admin.templates.letter-pads.create') }}" data-ajax-popup2="true"
                                            ...
                                            <td>
                                                <div class="dt-buttons">
                                                    <div class="text-end">
                                                        ...
                                                        @endcan
                                                        @can('edit letter pad template')
                                                            <div class="action-btn me-2">
                                                                <a href="#"
                                                                    class="mx-3 btn btn-sm d-inline-flex align-items-center bg-warning"
                                                                    data-bs-toggle="tooltip" title="{{ __('Edit') }}"
                                                                    data-url="{{ route('admin.templates.letter-pads.edit', $template->id) }}"
                                                        ...
                                                        @endcan
                                                        @can('delete letter pad template')
                                                            <div class="action-btn">
                                                                {!! Form::open([
                                                                    'method' => 'DELETE',
                                                                    'route' => ['admin.templates.letter-pads.destroy', $template->id],
