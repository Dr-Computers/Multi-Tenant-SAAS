                ...
                <li
                    ...
                    <ul
                        ...
                        {{-- @can('manage role') --}}
                            ...
                            <li
                            class="dash-item {{ Request::route()->getName() == 'lease.index' || Request::route()->getName() == 'lease.create' || Request::route()->getName() == 'lease.edit' || Request::route()->getName() == 'lease.show' ? ' active' : '' }}">
                            <a class="dash-link"
