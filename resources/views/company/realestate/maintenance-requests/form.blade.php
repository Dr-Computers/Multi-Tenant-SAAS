@canany(['create a maintenance request', 'edit a maintenance request'])
    ...
    function formHandler() {
        return {
            ...
            async submitForm() {
                ...
                const url =
                    `{{ isset($maintenance) ? route('company.realestate.maintenance-requests.update', $maintenance->id) : route('company.realestate.maintenance-requests.store') }}`;
                try {
