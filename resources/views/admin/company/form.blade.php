@canany(['create company', 'edit company'])
    <form action="{{ isset($user) ? route('admin.company.update', $user->id) : route('admin.company.store') }}" method="post"
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="country" value="{{ old('country', $user->company->country ?? '') }}"
