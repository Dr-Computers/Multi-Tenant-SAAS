...
@section('page-title')
    {{ __('Requested Categories') }}
@endsection
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Dashboard') }}</a></li>
    <li class="breadcrumb-item">{{ __('Requested Categories') }}</li>
@endsection


@section('action-btn')
    <div class="float-end">
        <a href="{{ route('admin.realestate.categories.index') }}" class="btn btn-sm btn-dark">
                                            ...
                                            <td class="Action">
                                                ...
                                                <div class="action-btn me-2">
                                                    <a href="#"
                                                        ...
                                                        data-url="{{ route('admin.realestate.categories.request-single', $category->id) }}"
