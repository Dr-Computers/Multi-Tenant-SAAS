...
@section('content')
    @can('edit a bank account')
        <div class="row">
            <form action="{{ route('company.finance.bank-accounts.update', $bankAccount->id) }}" method="POST"
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="holder_name" class="form-control"
                                            value="{{ old('holder_name', $bankAccount->holder_name) }}" required>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="account_type" class="form-control">
                                            ...
                                            <option value="savings"
                                                {{ old('account_type', $bankAccount->account_type) == 'savings' ? 'selected' : '' }}>
                                                Savings</option>
                                            <option value="current"
                                                {{ old('account_type', $bankAccount->account_type) == 'current' ? 'selected' : '' }}>
                                                Current</option>
                                            <option value="business"
                                                {{ old('account_type', $bankAccount->account_type) == 'business' ? 'selected' : '' }}>
                                                Business</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="closing_balance" class="form-control" step="0.01"
                                            value="{{ old('closing_balance', $bankAccount->closing_balance) }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="contact_number" class="form-control"
                                            value="{{ old('contact_number', $bankAccount->contact_number) }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email" class="form-control"
                                            value="{{ old('email', $bankAccount->email) }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="bank_branch" class="form-control"
                                            value="{{ old('bank_branch', $bankAccount->bank_branch) }}">
                                    </div>
                                </div>
