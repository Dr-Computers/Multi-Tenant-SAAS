...
class SectionRequestController extends Controller
{
    ...
    public function index()
    {
        ...
        // {
        $section_requests = SectionPlanRequest::all();

        return view('admin.plan_request.section-index', compact('section_requests'));
        // }
        // else
        // {
    ...
    */
    ...
    {
        $pRequest = SectionPlanRequest::where('id', $id)->first();
        if ($response == 0) {
