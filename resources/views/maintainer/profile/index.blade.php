    ...
    <div class="row">
        ...
        <div class="col-xl-9">
            <div id="personal_info" class="card">
                ...
                <div class="card-body">
                    {{ Form::model($userDetail, ['route' => ['company.profile.update'], 'method' => 'post', 'enctype' => 'multipart/form-data', 'class' => 'needs-validation', 'novalidate']) }}
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-sm-12">
                            <div class="col-lg-12 col-md-12 text-center">
                                <div class="form-group">
                                    <label for="profile" class="col-form-label text-dark">{{ __('Avtar') }}</label>

                                    <div class="choose-files ">
                                        <label for="avatar">
                                            <img id="blah"
                                            src="{{ !empty(\Auth::user()->avatar_url) ? \App\Models\Utility::get_file(\Auth::user()->avatar_url) : asset(Storage::url('uploads/avatar/avatar.png')) }}"
                                            class="img-fluid rounded border-2 mx-auto  border border-primary " width="120px"
                                            height="120px">
                                            <div class=" bg-primary profile_update mx-auto mt-2"> <i
            ...
            <div id="change_password" class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('company.profile.update.password') }}" class="needs-validation"
                        novalidate>
                        @csrf
                        <div class="row">
                            <div class="col-lg-6 col-sm-6 form-group">
                                <label for="current_password"
                                    class="col-form-label text-dark">{{ __('Old Password') }}</label><x-required></x-required>
                                <input class="form-control @error('current_password') is-invalid @enderror"
                                    name="current_password" type="password" id="current_password" required
                                    autocomplete="current_password" placeholder="{{ __('Enter Old Password') }}">
                            ...
                            <div class="col-lg-6 col-sm-6 form-group">
                                <label for="new_password"
                                    class="col-form-label text-dark">{{ __('New Password') }}</label><x-required></x-required>
                            ...
                            <div class="col-lg-6 col-sm-6 form-group">
                                <label for="confirm_password"
                                    class="col-form-label text-dark">{{ __('Confirm New Password') }}</label><x-required></x-required>
                                <input class="form-control @error('confirm_password') is-invalid @enderror"
                                    ...
                                    id="confirm_password" placeholder="{{ __('Enter Your Confirm Password') }}">
                            </div>
