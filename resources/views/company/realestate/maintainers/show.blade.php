...
@section('action-btn')
    <div class="d-flex">
        <a href="{{ route('company.realestate.maintainers.index') }}" title="{{ __('Back to maintainers') }}"
                ...
                <div class="card-body">
                    @can('maintainer user details')
                        ...
                        <ul class="nav nav-tabs" id="maintainerTabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ $tab == 'works' ? 'active' : '' }}"
                                    href="{{ route('company.realestate.maintainers.show', $maintainer->id) }}?tab=works">Assigned
                                    Works</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ $tab == 'activity_logs' ? 'active' : '' }}"
                                    href="{{ route('company.realestate.maintainers.show', $maintainer->id) }}?tab=activity_logs">Activity
                                    Log</a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content p-4 border border-top-0 rounded-bottom">
                            @if ($tab == 'overview')
                                @include('company.realestate.maintainers.partials._overview', [
                                    'maintainer' => $maintainer,
                                ])
                            @elseif($tab == 'works')
                                @include('company.realestate.maintainers.partials._works', [
                                    'maintainer' => $maintainer,
                                ])
                            ...
                            @elseif($tab == 'documents')
                                @include('company.realestate.maintainers.partials._documnets', [
                                    'maintainer' => $maintainer,
                                ])
                            @elseif($tab == 'activity_logs')
                                @include('company.realestate.maintainers.partials._activity_logs', [
                                    'maintainer' => $maintainer,
                                ])
                            @endif
                        </div>
