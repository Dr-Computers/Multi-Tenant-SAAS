...
class MaintainerController extends Controller
{
    ...
    {
        if (Auth::user()->can('maintainer user listing')) {
    ...
    {
        if (Auth::user()->can('create maintainer user')) {
    ...
    {
        if (Auth::user()->can('edit maintainer user')) {
    ...
    {
        if (Auth::user()->can('delete maintainer user')) {
            MaintenanceJob::where('user_id', $maintainer->id)->delete();
            $maintainer->delete();
            $this->logActivity(
    ...
    {
        if (Auth::user()->can('maintainer user details')) {
    ...
    {
        if (Auth::user()->can('upload maintainer documents')) {
            $user = User::find($id);
