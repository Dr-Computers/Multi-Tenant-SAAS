<div class="my-2 text-end">
    @can('upload owner documents')
        <button href="#" data-size="lg" data-url="{{ route('company.realestate.owners.create-documents', $owner->id) }}"
            ...
            <div class="card-body table-bdocuments-style">
                <div class="table-responsive">
                    <table class="table datatable">
                        ...
                        <tbody>
                            @forelse ($owner->documents ??  [] as $key => $document)
                                <tr>
                                    <td>{{ $key + 1 }}</td>
                                    <td>
                                    ...
                                    @can('upload owner documents')
                                        <td>
                                            ...
                                            <div class="action-btn">
                                                {!! Form::open([
                                                    'method' => 'DELETE',
                                                    'route' => ['company.realestate.owners.documents.destroy', $document->id],
