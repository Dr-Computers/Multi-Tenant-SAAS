...
@section('action-btn')
    <div class="float-end">
        @can('create role')
            <a href="#" data-size="xl" data-url="{{ route('admin.roles.create') }}" data-ajax-popup="true"
                data-bs-toggle="tooltip" title="{{ __('Create Role') }}" class="btn btn-sm btn-primary">
                                        ...
                                        <tr class="font-style">
                                            ...
                                            <td class="Permission">
                                                @for ($j = 0; $j < count($role->permissions()->pluck('name')); $j++)
                                                    <span
                                                        class="badge rounded-pill bg-primary">{{ $role->permissions()->pluck('name')[$j] }}</span>
                                                @endfor
                                            </td>
                                            <td class="Action">
                                                <span>
                                                    @can('edit role')
                                                        <div class="action-btn me-2">
                                                            <a href="#"
                                                                ...
                                                                data-bs-toggle="tooltip" title="{{ __('Edit Role') }}"
