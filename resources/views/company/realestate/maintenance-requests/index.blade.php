                ...
                <div class="card-body">
                    ...
                    <div class="tab-content p-4 border border-top-0 rounded-bottom">
                        ...
                        @elseif($tab == 'pending-requests')
                            @include('company.realestate.maintenance-requests.partials.pending-requests', [
                                'pendingRequests' => $pendingRequests,
                            ])
                        @elseif($tab == 'in-progress-requests')
                            @include('company.realestate.maintenance-requests.partials.in-progress-requests', [
                                'InprogressRequests' => $InprogressRequests,
                            ])
                        @elseif($tab == 'completed-requests')
                            @include('company.realestate.maintenance-requests.partials.completed-requests', [
