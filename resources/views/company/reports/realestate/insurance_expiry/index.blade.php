...
@section('content')
    <div class="row">
        ...
        <div style="display: flex; gap: 20px; align-items: center; flex-wrap: wrap; margin-bottom: 20px;">
            ...
            <form method="GET" action="{{ route('reports.insurance-expiry') }}">
            ...
            <a href="{{ route('reports.insurance-expiry') }}" class="btn btn-secondary btn-sm">
                {{ __('Clear') }}
            </a>
        </div>
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="display dataTable cell-border datatbl-advance"  data-report-name="Insurance Expiry Report">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                @php
                                    ...
                                    $formattedDate = \Carbon\Carbon::parse($result->insurance_expiry_date)->format('Y-m-d'); 
