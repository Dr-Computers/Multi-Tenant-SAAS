...
@section('action-btn')
    <div class="d-flex">
        <a href="{{ route('company.tickets.index') }}" class="btn btn-sm btn-primary me-2">
                                ...
                                <div class="">
                                    <div class="my-2">
                                        ...
                                        <span class="mb-3 fw-bold">Subject :
                                            {{ $tickets != null ? $ticketFirst->subject : '--' }}
                                        </span><br>
    ...
    function formHandler() {
        return {
            ...
            async submitForm() {
                ...
                try {
                    const response = await fetch(`{{ route('company.tickets.reply', $ticket->ticket_no) }}`, {
                        method: 'POST',
                        headers: {
