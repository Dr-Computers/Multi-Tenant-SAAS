...
<div class="modal-body">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.realestate.amenities.request-accept', $categoryRequest->id) }}"
                        method="POST" class="">
                        @csrf
                        ...
                        <div class="form-group mt-4">
                            @if ($categoryRequest->status == 0)
                                <button type="submit"
                                    formaction="{{ route('admin.realestate.amenities.request-reject', $categoryRequest->id) }}"
