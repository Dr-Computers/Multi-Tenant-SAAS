    ...
    <div class="row">
        <div class="col-12 text-center mb-4">
            ...
            <p class="text-muted" style="font-size: 0.9rem;">
                {{ __('A comprehensive view of all your bank accounts and their balances.') }}</p>
        </div>
        ...
        <div style="display: flex; gap: 20px; align-items: center; flex-wrap: wrap; margin: 20px;">
            ...
            <form method="GET" action="{{ route('company.report.bank_transactions.index') }}">
                ...
                <a href="{{ route('company.report.bank_transactions.index') }}" class="btn btn-secondary btn-sm">
                    {{ __('Clear') }}
                </a>
            </form>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <table class="display transactions-table dataTable cell-border datatbl-advance-land reports-table"
                        data-report-name="Bank Transactions Report">
                        <thead>
                            <tr>
